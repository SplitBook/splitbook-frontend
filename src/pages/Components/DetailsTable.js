...
export default function DetailsTable() {
  ...
  const [state2, setState2] = React.useState({
    columns: [
      ...
      { title: "Valido", field: "valid",render: (rowData) => (
        <>
        {
  ...
  return (
    <>
        ...
        <Grid container spacing={2} style={{marginBottom:20}}>
          <Grid item >
            <TextField variant="outlined" value={enrollmentsInfo.student_name} helperText="Nome do Aluno" disabled/>
          </Grid>
          <Grid item >
            <TextField variant="outlined" value={enrollmentsInfo.student_number} helperText="Nº do Aluno" disabled/>
          </Grid>
          <Grid item >
            <TextField variant="outlined" value={enrollmentsInfo.class} helperText="Turma" disabled/>
          </Grid>
          <Grid item >
            <TextField variant="outlined" value={enrollmentsInfo.guardian_name} helperText="Encarregado de Educação" disabled/>
          </Grid>
        </Grid>
      {
      ...
      >
        ...
        data={(query) =>
          new Promise((resolve, reject) => {
            let url =
              "http://localhost:8085/reports/"+reportID;
            fetch(url, {
              headers: {
                method: "GET",
